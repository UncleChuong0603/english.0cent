  ...
  return (
    <section className='flex-col px-10 py-10 space-y-10 text-justify'>
        <div className='flex-center w-full'>
          <Link href="/about_me/resume" className='w-2/3 h-24 bg-black rounded-3xl px-3 py-3 text-white font-bold text-4xl flex-center'>Resume</Link>
          <Link href="/about_me/portfolio" className='w-1/3 h-18 bg-gray-500 rounded-r-3xl px-3 py-3 text-white font-bold text-2xl flex-center'>Portfolio</Link>
        </div>
        <section className='w-full h-auto flex-col  bg-white rounded-3xl items-start space-y-10 py-10'>
            <div className='flex-between items-center'>
                <div className='w-1/2 head_text px-10 flex-start'>Profile</div>
                </div>
          
            <div className='flex'>
                <div className='w-2/3 h-auto flex-col space-y-5 px-10'>
                ...
                <div className='w-1/3 h-72   bg-gray-100 rounded-3xl mr-10'></div>
            </div>
            ...
            <div className='flex'>
                <div className='w-full h-auto flex-col space-y-10 px-10'>
                    ...
                    <div className='flex-start space-x-10'>
                      <div className='w-2/3'>
                        <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Ullam illum ad doloremque provident, repudiandae aliquid impedit unde, eos repellendus ratione eius consequatur ab quam necessitatibus aperiam aut, cupiditate blanditiis? Reiciendis dolorum sapiente, nisi magni earum quaerat! Assumenda architecto sint nobis voluptatum rem amet? Modi nobis rem quasi tenetur. Eos, voluptatem!</p>
                        <div className='w-full h-auto flex-center space-x-10 px-10 mt-5'>
                          <div className='w-1/3 h-12   bg-gray-100 rounded-3xl flex-center'>Easy</div>
                          <div className='w-1/3 h-12   bg-gray-100 rounded-3xl flex-center'>Grammar</div>
                          <div className='w-1/3 h-12   bg-gray-100 rounded-3xl flex-center'>Tense</div>
                        </div>
                      </div>
                      <div className='w-1/3 h-48   bg-gray-100 rounded-3xl mr-10'></div>
                    </div>
                ...
                <div className='w-full h-auto flex-col space-y-10 px-10'>
                    ...
                    <div className='flex-col'>
                      ...
                      <div className='flex space-x-10'>
                        <div className='w-2/3 h-20 flex-col  bg-gray-100 rounded-t-3xl px-5 py-5 space-y-5'>
                        <p className='text-center text-4xl font-bold'>Foreign Languages</p>
                        
                      </div>
                      <div className='w-1/3 h-16 flex-center  bg-gray-300 rounded-3xl px-5 py-5 space-y-5'>
                        <p className='text-center text-2xl font-bold'>Code Skills</p>
                      ...
                      <div className='w-full h-24 flex-center  bg-gray-100 rounded-3xl px-10 space-x-3'>
                        <div className='w-1/4 font-bold text-2xl'>IELTS</div>
                    ...
                    <div className='flex-col'>
                      ...
                      <div className='flex space-x-10'>
                        ...
                        <p className='text-center text-2xl font-bold'>Foreign Languages</p>
                        
                      </div>
                      <div className='w-2/3 h-20 flex-col  bg-gray-100 rounded-t-3xl px-5 py-5 space-y-5'>

                        <p className='text-center text-4xl font-bold'>Code Skills</p>
