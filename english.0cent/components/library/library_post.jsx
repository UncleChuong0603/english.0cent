...
const library_post = () => {
  return (
    <section className='w-full h-auto flex-col space-y-10'> 
      <section className='w-full h-auto flex-col bg-white rounded-3xl items-start space-y-10 py-10'>
        ...
        <div className='w-full h-auto flex px-10 space-x-10'>
          <div className='w-1/2 h-20 bg-gray-100 rounded-3xl flex-center text-2xl font-bold'>Donate</div>
          <div className='w-1/2 h-20 bg-gray-100 rounded-3xl flex-center text-2xl font-bold'>Download</div>
        </div>
      </section>
    </section>
  )
