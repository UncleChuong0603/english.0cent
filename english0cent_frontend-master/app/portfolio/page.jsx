  ...
  return (
    <section className='flex-col px-10 py-10 space-y-10 text-justify'>
      <div className='flex-center w-full'>
        <Link href="resume" className='w-1/3 h-18 bg-gray-500 rounded-l-3xl px-3 py-3 text-white font-bold text-2xl flex-center transform transition duration-500 hover:scale-105'>Resume</Link>
        <Link href="portfolio" className='w-2/3 h-24 bg-black rounded-3xl px-3 py-3 text-white font-bold text-4xl flex-center z-50'>Portfolio</Link>
      </div>
